...
-(void)getDataFromPath:(NSString *)path withParamData:(NSMutableDictionary *)dictParam withBlock:(RequestCompletionBlock)block
{
    ...
    {
        url =[[NSString stringWithFormat:@"http://androidmobiapps.com/oro/webservices/%@",path] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    }
    else
    {
        url =[[NSString stringWithFormat:@"http://androidmobiapps.com/oro/webservices/%@",path] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
...
//    NSLog(@"%@",dictParam);
    ...
    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json", @"text/json", @"text/javascript",@"text/html",@"application/osm3s+xml", nil];
...
-(void)getDataFromPath:(NSString *)path withParamDataImage:(NSMutableDictionary *)dictParam andImage:(UIImage *)image withBlock:(RequestCompletionBlock)block
{
    ...
    if (imageToUpload)
    {
        NSString *url=[[NSString stringWithFormat:@"http://androidmobiapps.com/oro/webservices/%@",path] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
...
-(void)getAddressFromGooglewithParamData:(NSMutableDictionary *)dictParam withBlock:(RequestCompletionBlock)block
{
    ...
    //[raw urlEncodeUsingEncoding:NSUTF8Encoding]
    NSString *url=[[NSString stringWithFormat:@"%@",@""] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
